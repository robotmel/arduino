...
#include "U8glib.h" //загружаем библиотеку U8glib для управления дисплеем

U8GLIB_SSD1306_128X64 u8g(U8G_I2C_OPT_NONE); //декларируем дисплей (библиотека U8glib v1.14)
